...
class Fraction(object):
    ...
    def __eq__(self, other):
        ...
        '''
        '''
        if we put in f == g in the code, this function is called to
        check if they are equal b/c that's this function's purpose,
        so the function __eq__ is called. This is called operator overloading.'''
    ...
    def __int__(self):
        ...
        Returns:
            the integer value of this fraction.'''
